...
double BME280::sealevel(double P, double A, double T) // pressure P (in mb) , Altitude A (in meters), temperature T in Celsius , return the equivalent pressure (in mb) at sea level.
{
